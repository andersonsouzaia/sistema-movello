...
const FAQSection = () => {
  return (
    <section id="faq" className="section-padding bg-gradient-to-br from-primary to-movello-blue-dark">
      <div className="container-section">
        ...
        >
          <span className="inline-block px-4 py-2 bg-primary-foreground/20 text-primary-foreground rounded-full text-sm font-semibold mb-4">
            FAQ
          </span>
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                ...
                <AccordionContent className="text-primary-foreground/90 pb-6 leading-relaxed">
                  {faq.answer}
                </AccordionContent>
              </AccordionItem>
            ))}
