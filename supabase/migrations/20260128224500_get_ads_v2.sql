CREATE OR REPLACE FUNCTION get_ads_for_location_v2(
...
BEGIN
    ...
    SELECT 
        ...
        c.descricao,
        c.categoria::text,
        c.midias_urls::jsonb, -- Explicit cast to ensure type match
        c.qr_code_link,
...
GRANT EXECUTE ON FUNCTION get_ads_for_location_v2 TO anon;
GRANT EXECUTE ON FUNCTION get_ads_for_location_v2 TO service_role;
